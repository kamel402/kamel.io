  ...
  return (
    <div className="flex flex-col md:flex-row justify-between relative">
      <h2 className="relative text-3xl w-full text-center md:text-left font-bold md:max-w-lg mb-10 md:mr-10 md:mb-0 md:w-max mr-0 ">
        ...
        <div className="sqD hidden md:block top-[140px] right-0 lg:top-[105px]">
          <Image
        ...
        <div className="sqD hidden md:block top-[200px] right-[50px] lg:top-[170px] lg:right-[50px]">
          <Image  
            src="/static/doodles/skills/youtube.svg"
            width={80} height={79} />
        </div>
        
        <div className="sqD top-[-15px] right-[-15px]">
          <Image
